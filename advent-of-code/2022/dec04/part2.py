...
def overlaps(start1, end1, start2, end2):
    # 43, 44, 7, 45
    return contains(start1, end1, start2) or contains(start1, end1, end2)
...
for line in open(infile):
    ...
    if fully_contains(range1_s, range1_e, range2_s, range2_e) or fully_contains(range2_s, range2_e, range1_s, range1_e) or overlaps(range1_s, range1_e, range2_s, range2_e):
        overlapping = True
        count = count + 1
        
    print("{}: {}".format(line, overlapping))
