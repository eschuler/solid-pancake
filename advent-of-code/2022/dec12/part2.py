...
for line in open(infile):
    ...
    for char in line:
        ...
        if char == "a":
            start_locs.append((curr_row_idx, curr_col_idx))
...
min_shortest_path = 9999
    
for start_loc in start_locs:
    print("\nStart: {}".format(start_loc))
    ...
    print("Shortest path to peak: {}".format(shortest_path[end_loc[0]][end_loc[1]]))
    
    if shortest_path[end_loc[0]][end_loc[1]] != -1 and shortest_path[end_loc[0]][end_loc[1]] < min_shortest_path:
        min_shortest_path = shortest_path[end_loc[0]][end_loc[1]]
    
    #break
    
print("\nMin shortest path: {}".format(min_shortest_path))
